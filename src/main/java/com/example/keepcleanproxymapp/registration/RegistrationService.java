...
import com.example.keepcleanproxymapp.email.EmailSender;
...
import com.example.keepcleanproxymapp.token.ConfirmationToken;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        emailSender.send(
                request.email(),"akkaricherifa@gmail.com",
